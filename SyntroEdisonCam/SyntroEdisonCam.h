...
#ifndef SYNTROEDISONCAM_H
#define SYNTROEDISONCAM_H

#include <QThread>

#define PRODUCT_TYPE "SyntroEdisonCam"

class CamClient;
class VideoDriver;
class AudioDriver;

class SyntroEdisonCam : public QThread
{
    Q_OBJECT

public:
    SyntroEdisonCam(bool daemonMode, QObject *parent);
